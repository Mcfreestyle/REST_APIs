...
for i in range(nUsers):
    ...
    users_list.append("""('{}', '{}', '{}', '{}', '{}')""".format(
        user_id, user_name, password, created_at, updated_at
    ))
...
for i in range(nUsers):
    ...
    todo_lists.append("""('{}', '{}', '{}', '{}', '{}')""".format(
        todo_list_id, name, user_id, created_at, updated_at
    ))
...
for i in range(nTasks):
    ...
    tasks_list.append("""('{}', '{}', '{}', '{}', '{}', '{}', '{}')""".format(
        task_id, name, due_date, todo_list_id, status, created_at, updated_at
    ))
...
create_SQL_script(data_dict, 'book_db')
